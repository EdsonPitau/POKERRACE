const CACHE_NAME = 'poker-race-v17';
const ASSETS = [
  './',
  './index.html',
  './engine.js',
  ...
  './kart_red_token.png',
  './icons/icon-32.png', './icons/icon-48.png', './icons/icon-72.png',
  ...
  './screenshots/screenshot-start.png', './screenshots/screenshot-gameplay.png'
];
